...
func parseFormTag(fieldT reflect.StructField) (label, name, fType string, id string, class string, ignored bool, required bool) { // NOSONAR
...
func eq(arg1 interface{}, arg2 ...interface{}) (bool, error) { // NOSONAR
