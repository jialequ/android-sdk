...
import (
	...
	"github.com/jialequ/android-sdk/server/web/grace"
)
...
func (app *HttpServer) Run(addr string, mws ...MiddleWare) { // NOSONAR
	initBeforeHTTPRun()
...
func findAndRemoveTree(paths []string, entryPointTree *Tree, method string) { // NOSONAR
