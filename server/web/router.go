...
import (
	...
	"github.com/jialequ/android-sdk/server/web/context/param"
)
...
func (p *ControllerRegister) getURL(t *Tree, url, controllerName, methodName string, params map[string]string, httpMethod string) (bool, string) { // NOSONAR
...
func (p *ControllerRegister) serveHttp(ctx *beecontext.Context) { // NOSONAR
	var err error
	startTime := time.Now()
	r := ctx.Request
