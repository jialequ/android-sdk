...
func (ini *IniConfig) parseData(dir string, data []byte) (*IniConfigContainer, error) { // NOSONAR
...
func (c *IniConfigContainer) SaveConfigFile(filename string) (err error) { // NOSONAR
