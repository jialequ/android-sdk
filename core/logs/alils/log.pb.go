...
func (m *Log) Unmarshal(data []byte) error { // NOSONAR
...
func (m *LogContent) Unmarshal(data []byte) error { // NOSONAR
	var hasFields [1]uint64
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
...
func (m *LogGroup) Unmarshal(data []byte) error { // NOSONAR
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *LogGroupList) Unmarshal(data []byte) error { // NOSONAR
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func skipLog(data []byte) (n int, err error) { // NOSONAR
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
