...
// Usage:
//
// import "github.com/jialequ/android-sdk/core/logs"
//
//	log := NewLogger(10000)
...
func (bl *BeeLogger) Warn(format string, v ...interface{}) { // NOSONAR
	if LevelWarn > bl.level {
		return
	}
	lm := &LogMsg{
...
func (bl *BeeLogger) Info(format string, v ...interface{}) { // NOSONAR
	if LevelInfo > bl.level {
		return
	}
	lm := &LogMsg{
...
func (bl *BeeLogger) Trace(format string, v ...interface{}) { // NOSONAR
	if LevelDebug > bl.level {
		return
	}
	lm := &LogMsg{
