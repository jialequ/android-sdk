...
//
//	import (
//		"github.com/jialequ/android-sdk/core/validation"
//		"log"
//	)
//
//	type User struct {
...
func (v *Validation) apply(chk Validator, obj interface{}) *Result { // NOSONAR
	if nil == obj {
...
func (v *Validation) Valid(obj interface{}) (b bool, err error) { // NOSONAR
