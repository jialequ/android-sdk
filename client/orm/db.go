...
import (
	...
	"github.com/jialequ/android-sdk/client/orm/internal/buffers"

	"github.com/jialequ/android-sdk/client/orm/internal/utils"

	"github.com/jialequ/android-sdk/client/orm/internal/models"

	"github.com/jialequ/android-sdk/client/orm/hints"
)
...
func (d *dbBase) collectValues(mi *models.ModelInfo, ind reflect.Value, cols []string, skipAuto bool, insert bool, names *[]string, tz *time.Location) (values []interface{}, autoFields []string, err error) { // NOSONAR
	if names == nil {
...
func (d *dbBase) collectFieldValue(mi *models.ModelInfo, fi *models.FieldInfo, ind reflect.Value, insert bool, tz *time.Location) (interface{}, error) { // NOSONAR
	var value interface{}
	if fi.Pk {
...
func (d *dbBase) InsertMulti(ctx context.Context, q dbQuerier, mi *models.ModelInfo, sind reflect.Value, bulk int, tz *time.Location) (int64, error) { // NOSONAR
	var (
		cnt    int64
		nums   int
		values []interface{}
...
func (d *dbBase) InsertOrUpdateSQL(names []string, values *[]interface{}, mi *models.ModelInfo, a *alias, args ...string) (string, error) { // NOSONAR
...
func (d *dbBase) Update(ctx context.Context, q dbQuerier, mi *models.ModelInfo, ind reflect.Value, tz *time.Location, cols []string) (int64, error) { // NOSONAR
...
func (d *dbBase) DeleteBatch(ctx context.Context, q dbQuerier, qs *querySet, mi *models.ModelInfo, cond *Condition, tz *time.Location) (int64, error) { // NOSONAR
	tables := newDbTables(mi, d.ins)
	tables.skipEnd = true
...
func (d *dbBase) ReadBatch(ctx context.Context, q dbQuerier, qs querySet, mi *models.ModelInfo, cond *Condition, container interface{}, tz *time.Location, cols []string) (int64, error) { // NOSONAR
...
func (d *dbBase) readSQL(buf buffers.Buffer, tables *dbTables, tCols []string, cond *Condition, qs querySet, mi *models.ModelInfo, tz *time.Location) []interface{} { // NOSONAR
...
func (d *dbBase) GenerateOperatorSQL(mi *models.ModelInfo, fi *models.FieldInfo, operator string, args []interface{}, tz *time.Location) (string, []interface{}) { // NOSONAR
	var sql string
...
func (d *dbBase) convertValueFromDB(fi *models.FieldInfo, val interface{}, tz *time.Location) (interface{}, error) { // NOSONAR
	if val == nil {
		return nil, nil
	}
...
func (d *dbBase) setFieldValue(fi *models.FieldInfo, value interface{}, field reflect.Value) (interface{}, error) { // NOSONAR
	fieldType := fi.FieldType
...
func (d *dbBase) ReadValues(ctx context.Context, q dbQuerier, qs querySet, mi *models.ModelInfo, cond *Condition, exprs []string, container interface{}, tz *time.Location) (int64, error) { // NOSONAR
	var (
		maps  []Params
		lists []ParamsList
		list  ParamsList
