...
import (
	...
	iutils "github.com/jialequ/android-sdk/client/orm/internal/utils"
...
func (o *ormBase) LoadRelatedWithCtx(_ context.Context, md interface{}, name string, args ...utils.KV) (int64, error) { // NOSONAR
...
func (o *orm) BeginWithCtxAndOpts(ctx context.Context, opts *sql.TxOptions) (TxOrmer, error) {
	...
	if Debug {
		txOrm.db = newDbQueryLog(o.alias, txOrm.db)
	}

	var taskTxOrm TxOrmer = txOrm
...
func doTxTemplate(ctx context.Context, o TxBeginner, opts *sql.TxOptions,
	...
	txOrm, err := o.BeginWithCtxAndOpts(ctx, opts)
	if err != nil {
		return err
	}
	panicked := true
