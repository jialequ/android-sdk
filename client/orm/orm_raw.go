...
func (o *rawSet) setFieldValue(ind reflect.Value, value interface{}) { // NOSONAR
	switch ind.Kind() {
	case reflect.Bool:
		if value == nil {
			ind.SetBool(false)
...
func (o *rawSet) loopSetRefs(refs []interface{}, sInds []reflect.Value, nIndsPtr *[]reflect.Value, eTyps []reflect.Type, init bool) { // NOSONAR
	nInds := *nIndsPtr
...
func (o *rawSet) QueryRow(containers ...interface{}) error { // NOSONAR
	var (
...
func (o *rawSet) QueryRows(containers ...interface{}) (int64, error) { // NOSONAR
	var (
		refs  = make([]interface{}, 0, len(containers))
		sInds []reflect.Value
		eTyps []reflect.Type
...
func (o *rawSet) readValues(container interface{}, needCols []string) (int64, error) { // NOSONAR
	var (
		maps  []Params
		lists []ParamsList
		list  ParamsList
...
func (o *rawSet) queryRowsTo(container interface{}, keyCol, valueCol string) (int64, error) { // NOSONAR
	var (
		maps Params
		ind  *reflect.Value
	)
