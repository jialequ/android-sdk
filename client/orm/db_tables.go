...
import (
	...
	"github.com/jialequ/android-sdk/client/orm/clauses"
	"github.com/jialequ/android-sdk/client/orm/clauses/order_clause"
)
...
func (t *dbTables) parseRelated(rels []string, depth int) { // NOSONAR
	relsNum := len(rels)
...
func (t *dbTables) getJoinSQL() (join string) { // NOSONAR
	Q := t.base.TableQuote()
...
func (t *dbTables) parseExprs(mi *models.ModelInfo, exprs []string) (index, name string, info *models.FieldInfo, success bool) { // NOSONAR
	var (
		jtl *dbTable
		fi  *models.FieldInfo
...
func (t *dbTables) getCondSQL(cond *Condition, sub bool, tz *time.Location) (where string, params []interface{}) { // NOSONAR
