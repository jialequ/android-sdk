...
import (
	...
	imodels "github.com/jialequ/android-sdk/client/orm/internal/models"
)
...
func getDbCreateSQL(mc *imodels.ModelCache, al *alias) (queries []string, tableIndexes map[string][]dbIndex, err error) { // NOSONAR
	if mc.Empty() {
		err = errors.New("no Model found, need Register your model")
		return
	}
