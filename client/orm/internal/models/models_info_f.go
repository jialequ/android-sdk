...
func NewFieldInfo(mi *ModelInfo, field reflect.Value, sf reflect.StructField, mName string) (fi *FieldInfo, err error) { // NOSONAR
	var (
		tag       string
		tagValue  string
		initial   utils.StrTo // store the default value
...
checkType:
	...
	case Fielder:
		...
		if fieldType&IsRelField > 0 {
			err = fmt.Errorf("unsupport type custom field, please refer to https://github.com/jialequ/android-sdk/blob/master/orm/models_fields.go#L24-L42")
			goto end
		}
	default:
		tag = "rel"
